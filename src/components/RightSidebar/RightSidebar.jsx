...
const RightSidebar = () => {
    return (
        <div>
            <div className="sticky top-24 p-4 flex gap-4 flex-col">
                ...
                <div className="">
                    ...
                    <p className="flex items-center gap-2 border-x-2 p-4"><FaSquareXTwitter className="text-4xl"></FaSquareXTwitter> X (formerly Twitter)</p>
